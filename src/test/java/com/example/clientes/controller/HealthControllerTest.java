...
/**
 * Tests unitarios para el endpoint /health de ms-clientes.
 *
...
class HealthControllerTest {
    ...
    @Test
    @DisplayName("GET /health - debe identificarse como ms-clientes")
    void health_shouldReturnCorrectServiceName() throws Exception {
        mockMvc.perform(get("/health"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.service").value("ms-clientes"))
